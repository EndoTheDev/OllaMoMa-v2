...
<template>
	<div
		...
		<div>
			<h3 class="font-medium">Theme Color</h3>
			<p class="text-sm text-[var(--ui-text-muted)]">Choose your preferred theme color</p>
		</div>
		<URadioGroup
			...
			@update:model-value="
				(value: string) =>
					settingsStore.setTheme(
						value as 'blue' | 'green' | 'red' | 'yellow' | 'purple' | 'pink' | 'indigo' | 'neutral'
					)
			"
			:ui="{
